...
["장애물을 인식 자동차 프로그래밍"](https://coding.msalt.net/car-programming)에서 조립된 자동차가 장애물을 피해서 주행하도록 만들어 봅시다.
...
["장애물을 인식 자동차 프로그래밍"](https://coding.msalt.net/car-programming)에서 조립한 자동차에 추가로 LED를 연결합니다.

LED 불 빛이 동작하도록 붉은 색과 초록 색 LED를 각각 저항과 함께 회로에 연결해 줍니다.

![led-circuit](./img/led-circuit.png)
...
![buzzer-circuit](./img/buzzer-circuit.png)
...
전체 프로그램을 모두 완성하기 전에 우선 거리에 따라 속도를 다르게 이동하는 부분만 먼저 구현을 해보겠습니다. 이 부분은 ["장애물을 인식 자동차 프로그래밍"](https://coding.msalt.net/car-programming)에서 구현했던 내용과 동일합니다.
