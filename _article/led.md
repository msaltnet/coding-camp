...
LED에 대해서 알아보고 아두이노를 통해서 LED를 깜빡이는 방법에 대해서 설명한다.
...
https://codingrun.com/65
저항 읽는 방법 소개

준비한 LED의 필요 전압은 2V이며, 소모 전류는 25mA입니다. 아두이노에서 나오는 전압은 5V이기 때문에 필요한 저항은 120Ω 정도 된다는 것을 알 수 있습니다.

V(전압) = I(전류) x R(저항)

저항과 LED, 전지를 직렬로 연결하면 원하는 양의 전류를 LED에 흐르게 할 수 있습니다.

https://blog.naver.com/NBlogTop.naver?isHttpsRedirect=true&blogId=jamduino&Redirect=Dlog&Qs=/jamduino/220822597063
//회로도
...
단순히 전원이 들어와서 불이 켜져있는 것이 아니라 프로그램으로 불을 켜고 끄는 것을 해보겠습니다.
...
1. 전기가 흐르면 빛이 나는 반도체가 있다.
1. 신호를 내 마음대로 프로그래밍 할 수 있는 반도체가 있다.
